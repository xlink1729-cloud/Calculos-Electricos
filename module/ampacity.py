...
def calculate_adjusted_ampacity(material: str, awg: str, temp_rating: str, ambient_temp: int, num_conductors: int) -> dict:
    ampacity_data = get_ampacity_data()
    temp_data = get_temp_correction_data()["ambient_temp_c"]
    
    # Ampacidad base de la tabla 310.16
    base_ampacity = ampacity_data[material][awg][temp_rating]
    
    # Factores de corrección
    f_temp = get_temp_factor(ambient_temp, temp_rating, temp_data)
